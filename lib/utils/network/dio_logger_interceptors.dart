...
//     WDMLogger.log('| [DIO] Request: ${options.method} ${options.uri}');
//     WDMLogger.log('| ${options.data.toString()}');
//     WDMLogger.log('| Headers:');
//     options.headers.forEach((key, value) {
//       WDMLogger.log('|\t$key: $value');
//     });
//     handler.next(options);
//   }
...
//     WDMLogger.log("| [DIO] Error: ${e.error}: ${e.response.toString()}");
//     WDMLogger.log(
//         "└------------------------------------------------------------------------------");
//     handler.next(e);
//   }
...
//   WDMLogger.log("| [DIO] Error: ${error.error}: ${error.response.toString()}");
//   WDMLogger.log(
//       "└------------------------------------------------------------------------------");
